...
Base.broadcasted(::typeof(*), a::Real, b::IDMMOBILBehavior) = a*b
Base.broadcasted(::typeof(*), b::IDMMOBILBehavior, v::Vector{Float64}) = IDMMOBILBehavior(b.p_idm.*v[1:6], b.p_mobil.*v[7:9], 0)
^(b::IDMMOBILBehavior, p::Integer) = IDMMOBILBehavior(b.p_idm.^p, b.p_mobil.^p, 0)
Base.broadcasted(::typeof(^), b::IDMMOBILBehavior, p::Integer) = IDMMOBILBehavior(b.p_idm.^p, b.p_mobil.^p, 0)
Base.broadcasted(::typeof(-), v::Vector{B}, b::IDMMOBILBehavior) where {B<:BehaviorModel} = B[v[i]-b for i in 1:length(v)]
